...
namespace EsportsManager.BL.Services
{
    ...
    public class WalletService : IWalletService
    {
        ...
        // Mock data for development - có thể bỏ khi đã triển khai hoàn toàn với database
        ...
        public WalletService(ILogger<WalletService> logger, DataContext dataContext)
        {
            ...
            // Nếu không kết nối được database, sử dụng mock data
            if (!_useDatabase)
            {
                _logger.LogWarning("Database connection failed. Using mock data instead.");
                InitializeMockData();
            }
        }    /// <summary>
