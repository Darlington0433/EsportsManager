...
-- =====================================================
-- Module: Data Integrity Constraints
-- Description: Additional constraints to ensure data integrity
...
SELECT '15. Database constraints added successfully!' as Message;
