...
public interface IUserService
{
    ...
    Task<BusinessResult<UserDto>> UpdateUserAsync(UpdateUserDto updateUserDto);
    Task<BusinessResult<bool>> DeactivateUserAsync(int userId);
    Task<BusinessResult<bool>> ActivateUserAsync(int userId);
}
