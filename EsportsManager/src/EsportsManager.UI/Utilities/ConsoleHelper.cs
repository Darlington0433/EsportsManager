...
public static class ConsoleHelper
{
    ...
    public static void ShowWelcomeScreen()
    {
        ...
        var welcomeMessage = _configuration?["UI:WelcomeMessage"] ?? "Chào mừng đến với Hệ thống Quản lý Esports!";
    ...
    /// </summary>
    public static void PressAnyKeyToContinue(string message = "Nhấn phím bất kỳ để tiếp tục...")
    {
        Console.WriteLine();
    ...
    // We already have a WaitForKey method defined below, so we don't need this alias
    ...
    /// Wait for user input
    /// </summary>
    public static void WaitForKey(string message = "Nhấn phím bất kỳ để tiếp tục...")
    {
        Console.WriteLine();
        Console.ForegroundColor = GetColor("Info");
        Console.WriteLine(message);
