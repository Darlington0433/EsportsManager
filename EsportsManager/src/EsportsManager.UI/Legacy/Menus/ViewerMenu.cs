...
namespace EsportsManager.UI.Legacy.Menus
{
    ...
    public class ViewerMenu : BaseMenu
    {
        ...
        /// <summary>
        /// Xử lý chức năng quản lý ví điện tử
        /// </summary>
        private void ManageEWallet()
        {
            try
            {
                Console.Clear();
                Console.WriteLine("=== QUẢN LÝ VÍ ĐIỆN TỬ ===");
                Console.WriteLine("Chức năng đang được phát triển...");
                Console.WriteLine("\nNhấn phím bất kỳ để quay lại");
                Console.ReadKey(true);
            }
        ...
        /// <summary>
        /// Xử lý chức năng bình chọn (Vote)
        /// </summary>
        private void Vote()
        {
            try
            {
                Console.Clear();
                Console.WriteLine("=== BÌNH CHỌN (VOTE) ===");
                Console.WriteLine("Chức năng đang được phát triển...");
                Console.WriteLine("\nNhấn phím bất kỳ để quay lại");
                Console.ReadKey(true);
            }
